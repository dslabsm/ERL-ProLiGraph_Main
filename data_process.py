...
def create_dataset_for_test(dataset):
    ...
    test_dataset = Dataset(root='data', dataset=dataset + '_test', xd=test_drugs, y=test_Y,
...
def create_dataset_for_5folds(dataset, fold=0):
    ...
    train_dataset = Dataset(root='data', dataset=dataset + '_' + 'train', xd=train_drugs, target_key=train_prot_keys,
    ...
    valid_drugs, valid_prots_keys, valid_Y = np.asarray(valid_drugs), np.asarray(valid_prots_keys), np.asarray(
        valid_Y)
    valid_dataset = Dataset(root='data', dataset=dataset + '_' + 'train', xd=valid_drugs,
